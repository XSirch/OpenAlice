...
export type WorkspaceSource = 'chat' | 'auto-quant' | 'alice-portfolio'
...
export type ViewSpec =
  ...
  | { kind: 'corporate-events'; params: Record<string, never> }
  ...
  | { kind: 'alice-portfolio-landing'; params: Record<string, never> }
