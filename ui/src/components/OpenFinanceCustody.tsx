...
import { api } from '../api'
import type { CustodySnapshot, FgcExposure, FixedIncomeLadder } from '../api/open-finance'
...
export function OpenFinanceCustody({ onSnapshotChange }: { onSnapshotChange?: (snapshot: CustodySnapshot | null) => void }) {
  ...
  const load = useCallback(async () => {
    try {
      ...
      } else { onSnapshotChange?.(null); setFgc(null); setLadder(null) }
