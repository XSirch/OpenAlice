...
describe('FileContentView', () => {
  it('renders .html reports in the isolated report viewer', () => {
    render(<FileContentView path="research/close.html" result={{ kind: 'ok', content: '<h1>Close</h1>', revision: 'r1' }} />)
  ...
  it('does not treat the legacy .htm extension as an HTML report', () => {
    render(<FileContentView path="research/legacy.htm" result={{ kind: 'ok', content: '<h1>Legacy</h1>', revision: 'r1' }} />)
