/**
 * 0045_retire_workspace_agent_pins — remove the retired per-Workspace adapter
...
export const migration: Migration = {
  id: '0045_retire_workspace_agent_pins',
  ...
  up: async (ctx) => {
    ...
    await migrateWorkspaceAgentPins(launcherRoot, {
      backupRoot: join(
        ...
        '_backup',
        `${timestamp}-pre-0045_retire_workspace_agent_pins`,
        'workspace-registry',
      ),
    })
  },
